...
! function($) {
    ...
    $.fn.fileuploader = function(q) {
        return this.each(function(t, r) {
                ...
                f = {
                    ...
                    thumbnails: {
                        ...
                        generateFileIcon: function(e, t) {
                            var o = '<div style="${style}" class="fileuploader-item-icon${class}"><i>' + (t || "") + "</i></div>",
                                r = f._assets.textToColor(t);
                            r && (f._assets.isBrightColor(r) && (o = o.replace("${class}", " is-bright-color")), o = o.replace("${style}", "background-color: " + r));
                            ...
                            if (i.length) {
                                if (e.image = i.html("").addClass("fileuploader-loading"), (["image", "video", "audio", "astext"].indexOf(e.format) > -1 || e.data.thumbnail) && f.isFileReaderSupported() && !a && (e.appended || n.thumbnails.startImageRenderer || t)) {
                                    ...
                                    return "string" == typeof r || "object" == typeof r ? h(r) : f.files.read(e, function() {
                                        e.reader.node && n.thumbnails.popup && e.html.addClass("file-has-popup"), e.reader.node && (e.reader.frame || "img" == e.reader.node.nodeName.toLowerCase()) ? h(e.reader.frame || e.reader.src, !0) : (u("image" == e.format), c())
                                    }, null, r, !0)
                                }
                                u()
                            } else c()
                        ...
                        popup: function(e, t) {
                            if (n.thumbnails.popup && n.thumbnails._selectors.popup) {
                                    ...
                                    a = function() {
                                        var a = e.popup.html || $(f._assets.textParse(n.thumbnails.popup.template, e)),
                                            ...
                                            u = function(t) {
                                                ...
                                                27 == o && e.popup && e.popup.close && e.popup.close(), 37 != o && 39 != o || !n.thumbnails.popup.arrows || e.popup.move(37 == o ? "prev" : "next")
                                            };
                                        i.removeClass("loading"), i.children(n.thumbnails._selectors.popup).length && ($.each(f._itFl, function(o, r) {
                                            r != e && r.popup && r.popup.close && r.popup.close(t)
                                        }), i.find(n.thumbnails._selectors.popup).remove()), a.show().appendTo(i), e.popup.html = a, e.popup.move = function(t) {
                                            ...
                                            e.reader.node && e.reader.node.pause && e.reader.node.pause(), $(window).off("keyup", u), r.css({
                                                overflow: "",
                                                width: ""
                                            }), e.popup.editor && e.popup.editor.cropper && e.popup.editor.cropper.hide(), e.popup.html && n.thumbnails.popup.onHide && $.isFunction(n.thumbnails.popup.onHide) ? n.thumbnails.popup.onHide(e, l, p, o, s) : e.popup.html && e.popup.html.remove(), t || i.fadeOut(400, function() {
                                                i.remove()
                                            }), delete e.popup.close
                                        }, e.reader.node ? (d && a.find(".fileuploader-popup-node").html(e.reader.node), e.reader.node.controls = !0, e.reader.node.currentTime = 0, e.reader.node.play && e.reader.node.play()) : a.find(".fileuploader-popup-node").html('<div class="fileuploader-popup-file-icon">' + e.icon + "</div>"), $(window).on("keyup", u), r.css({
                                            overflow: "hidden",
                                            width: r.innerWidth()
                                        }), e.popup.html.find('[data-action="prev"], [data-action="next"]').removeAttr("style"), e.popup.html[1 != f._itFl.length && n.thumbnails.popup.arrows ? "addClass" : "removeClass"]("fileuploader-popup-has-arrows"), n.thumbnails.popup.loop || (0 == f._itFl.indexOf(e) && e.popup.html.find('[data-action="prev"]').hide(), f._itFl.indexOf(e) == f._itFl.length - 1 && e.popup.html.find('[data-action="next"]').hide()), e.editor && e.popup.editor && e.popup.editor.hasChanges ? (e.popup.editor && e.popup.editor.rotation && f.editor.rotate(e, e.editor.rotation || 0, !0), e.popup.editor && e.popup.editor.cropper && (e.popup.editor.cropper.hide(!0), setTimeout(function() {
                                ...
                                0 == i.length && (i = $('<div class="fileuploader-popup"></div>').appendTo(r)), i.fadeIn(400).addClass("loading"), ["image", "video", "audio", "astext"].indexOf(e.format) > -1 && !e.popup.html ? f.files.read(e, a) : a()
                            }
                        }
                    },
                    editor: {
                                    ...
                                    step: function(e, t) {
                                        ...
                                        if ("none" !== o) {
                                            var l = o.split("(")[1].split(")")[0].split(","),
                                                s = l[0],
                                                p = l[1];
                                            r = "rotation" == a ? e : Math.round(Math.atan2(p, s) * (180 / Math.PI)), n = "scale" == a ? e : Math.round(10 * Math.sqrt(s * s + p * p)) / 10
                                        }
                                        i.css({
                                            "-webkit-transform": "rotate(" + r + "deg) scale(" + n + ")",
                                            "-moz-transform": "rotate(" + r + "deg) scale(" + n + ")",
                                            transform: "rotate(" + r + "deg) scale(" + n + ")"
                                        })
                                    },
                                    always: function() {
                                ...
                                e.popup.editor.cropper = {
                                    ...
                                    setDefaultData: function() {
                                        ...
                                        return t.crop = {
                                            ...
                                            width: i ? n * a : r,
                                            height: i ? r * a : n,
                                            cfWidth: r / t.$imageEl.prop("naturalWidth"),
                                    ...
                                    resize: function(t) {
                                        var o = e.popup.editor.cropper,
                                            r = o.$imageEl;
                                        r.width() > 0 && (t ? (o.$template.hide(), clearTimeout(o._resizeTimeout), o._resizeTimeout = setTimeout(function() {
                                            delete o._resizeTimeout;
                                            var e = r.width() / r.prop("naturalWidth"),
                                                t = r.height() / r.prop("naturalHeight");
                                        ...
                                        }, 500)) : (o.crop.cfWidth = r.width() / r.prop("naturalWidth"), o.crop.cfHeight = r.height() / r.prop("naturalHeight")))
                                    },
                                    drawPlaceHolder: function(t) {
                                        var o = e.popup.editor.cropper,
                                            r = e.popup.editor.rotation || 0,
                                            n = e.popup.editor.scale || 1,
                                            i = [0, 0];
                                        t && (t = $.extend({}, t), r && (i = [180 == r || 270 == r ? -100 : 0, 90 == r || 180 == r ? -100 : 0]), o.$editor.css(t), o.$editor.find(".area-image img").removeAttr("style").css({
                                            width: o.$imageEl.width(),
                                            height: o.$imageEl.height(),
                                            left: -1 * o.$editor.position().left,
                                            top: -1 * o.$editor.position().top,
                                            "-webkit-transform": "rotate(" + r + "deg) scale(" + n + ") translateX(" + i[0] + "%) translateY(" + i[1] + "%)",
                                            "-moz-transform": "rotate(" + r + "deg) scale(" + n + ") translateX(" + i[0] + "%) translateY(" + i[1] + "%)",
                                            transform: "rotate(" + r + "deg) scale(" + n + ") translateX(" + i[0] + "%) translateY(" + i[1] + "%)"
                                        }))
                                    },
                                    mousedown: function(t) {
                                        var o = t.originalEvent.touches && t.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                            r = $(t.target),
                                            n = e.popup.editor.cropper,
                                            i = {
                                            ...
                                            a = function() {
                                                n.pointData = {
                                                    ...
                                                    x: i.x,
                                                    y: i.y,
                                                    xEditor: i.x - n.crop.left,
                                                    yEditor: i.y - n.crop.top,
                                                    left: n.crop.left,
                                                    top: n.crop.top,
                                                    width: n.crop.width,
                                                    height: n.crop.height
                                                }, r.is(".area-move") && (n.isMoving = !0), r.is(".point") && (n.isResizing = !0), (n.isMoving || n.isResizing) && (n.$editor.addClass("moving"), $("body").css({
                        ...
                        resize: function(e, t, o, r, n, i) {
                            var a = t.getContext("2d"),
                                l = (o = !o && r ? r * e.width / e.height : o, r = !r && o ? o * e.height / e.width : r, e.width / e.height),
                                s = l >= 1 ? o : r * l,
                                p = l < 1 ? r : o / l;
                            i && s < o && (p *= o / s, s = o), i && p < r && (s *= r / p, p = r);
                            ...
                            if (t.width = s, t.height = p, e.width < t.width || e.height < t.height || d < 2) {
                                ...
                                n || (a.fillStyle = "#fff", a.fillRect(0, 0, t.width, t.height)), a.drawImage(e, u, f, Math.min(e.width, t.width), Math.min(e.height, t.height))
                            } else {
                                ...
                                for (c.width = e.width / m, c.height = e.height / m, h.fillStyle = "#fff", h.fillRect(0, 0, c.width, c.height), h.drawImage(e, 0, 0, e.width / 2, e.height / 2); d > 2;) {
                                    var g = m + 2,
                                        v = e.width / m,
                                        b = e.height / m;
                                    v > c.width && (v = c.width), b > c.height && (b = c.height), h.drawImage(c, 0, 0, v, b, 0, 0, e.width / g, e.height / g), m = g, d--
                                }
                                v = e.width / m, b = e.height / m;
                                v > c.width && (v = c.width), b > c.height && (b = c.height), a.drawImage(c, 0, 0, v, b, 0, 0, s, p), c = h = null
                            }
                            a = null
                        },
                        save: function(e, t, r, i, a) {
                            ...
                            if (c.width = m.naturalWidth, c.height = m.naturalHeight, h.drawImage(m, 0, 0), void 0 !== e.editor.rotation) {
                                e.editor.rotation = e.editor.rotation || 0, c.width = g.indexOf(e.editor.rotation) > -1 ? m.naturalWidth : m.naturalHeight, c.height = g.indexOf(e.editor.rotation) > -1 ? m.naturalHeight : m.naturalWidth;
                    ...
                    sorter: {
                        ...
                        findItemAtPos: function(e) {
                            ...
                            return o.each(function(t, o) {
                                var n = $(o);
                                if (e.x > n.offset().left && e.x < n.offset().left + n.outerWidth() && e.y > n.offset().top && e.y < n.offset().top + n.outerHeight()) return r = n, !1
                            }), r
                        },
                        ...
                        send: function(e, t) {
                            if (e.upload) {
                                ...
                                e.upload.data = e.upload.formData, e.upload.xhr = function() {
                                    ...
                                    if (!e.upload.chunk || e.upload.chunk.isLast) delete e.upload.chunk, f.upload.progressHandling(null, e, e.upload.$ajax.xhrStartedAt, !0), e.uploaded = !0, delete e.upload, e.upload = {
                                        status: "successful",
                                        resend: function() {
                                            f.upload.retry(e)
                                        }
                    ...
                    files: {
                        add: function(e, t) {
                            ...
                            return "updated" != t ? (f._itFl.push(c), o = f._itFl.length - 1, r = f._itFl[o]) : (o = f._itFl.indexOf(e), f._itFl[o] = r = c), r.remove = function() {
                                f.files.remove(r)
                        ...
                        read: function(e, t, r, i, a) {
                            if (f.isFileReaderSupported() && !e.data.readerSkip) {
                                ...
                                if ("astext" == e.format) d.onload = function(t) {
                                    ...
                                    e.reader.node = o, e.reader.src = t.target.result, e.reader.length = t.target.result.length, o.innerHTML = e.reader.src.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), h()
                                }, d.onerror = function() {
                                    h(), e.reader = {
                                        read: e.reader.read
                                    }
                                    ...
                                    var o = new Image,
                                        r = function() {
                                            e.data && e.data.readerCrossOrigin && o.setAttribute("crossOrigin", e.data.readerCrossOrigin), o.src = t.target.result + (i && !c && -1 == t.target.result.indexOf("data:image") ? (-1 == t.target.result.indexOf("?") ? "?" : "&") + "d=" + Date.now() : ""), o.onload = function() {
                                                if (e.reader.exifOrientation) {
                                                    var t = document.createElement("canvas"),
                                                        ...
                                                        a = [0, 180];
                                                    t.width = n.naturalWidth, t.height = n.naturalHeight, r.drawImage(n, 0, 0), t.width = a.indexOf(i) > -1 ? n.naturalWidth : n.naturalHeight, t.height = a.indexOf(i) > -1 ? n.naturalHeight : n.naturalWidth;
                                                    var l = i * Math.PI / 180,
                                                        s = .5 * t.width,
                                                        p = .5 * t.height;
                                                    return r.clearRect(0, 0, t.width, t.height), r.translate(s, p), r.rotate(l), r.translate(.5 * -n.naturalWidth, .5 * -n.naturalHeight), r.drawImage(n, 0, 0), r.setTransform(1, 0, 0, 1, 0, 0), o.src = t.toDataURL(e.type, 1), void delete e.reader.exifOrientation
                                                }
                                                e.reader.node = o, e.reader.src = o.src, e.reader.width = o.width, e.reader.height = o.height, e.reader.ratio = f._assets.pxToRatio(e.reader.width, e.reader.height), h(), u && (e.reader = {
                                                    read: e.reader.read
                                                })
                                            }, o.onerror = function() {
                                                h(), e.reader = {
                                    ...
                                    n.thumbnails.exif && e.choosed ? f._assets.getExifOrientation(e.file, function(t) {
                                        t && (e.reader.exifOrientation = t), r()
                                    }) : r()
                                }, d.onerror = function() {
                                    h(), e.reader = {
                                        read: e.reader.read
                                    ...
                                    if (d.onerror = function() {
                                            e.reader.node = null, h(), e.reader = {
                                                read: e.reader.read
                                            }
                                        }, URL && "" !== v) {
                                        if (a && !n.thumbnails.videoThumbnail) return e.reader.node = g, h(), void(e.reader = {
                                            read: e.reader.read
                                        });
                                        m = c ? URL.createObjectURL(e.file) : e.file, g.onloadedmetadata = function() {
                                            ...
                                            if ("video" == e.format) {
                                                var t = document.createElement("canvas"),
                                                    o = t.getContext("2d");
                                                t.width = g.videoWidth, t.height = g.videoHeight, o.drawImage(g, 0, 0, t.width, t.height), e.reader.frame = f._assets.isBlankCanvas(t) ? null : t.toDataURL(), t = o = null
                                            }
                                            h()
                                        }, setTimeout(function() {
                                            e.data && e.data.readerCrossOrigin && g.setAttribute("crossOrigin", e.data.readerCrossOrigin), g.src = m
                                        }, 100)
                                    } else d.onerror()
                                } else d.onload = function(t) {
                                    e.reader.src = t.target.result, e.reader.length = t.target.result.length, h()
                        ...
                        list: function(e, t, r, i) {
                            var a = [];
                            return !n.sorter || r || i && "ignoreSorter" == i || f.sorter.save(!0), $.each(f._itFl, function(o, r) {
                                if (r.upload && !r.uploaded) return !0;
                                var n = r;
                                if ((t || e) && (n = (n.choosed ? "0:/" : "") + (t && null !== f.files.getItemAttr(r, t) ? f.files.getItemAttr(r, t) : r["string" == typeof r.file ? "file" : "name"])), e && (n = {
                                        file: n
                                    }, r.editor && (r.editor.crop || r.editor.rotation) && (n.editor = {}, r.editor.rotation && (n.editor.rotation = r.editor.rotation), r.editor.crop && (n.editor.crop = r.editor.crop)), void 0 !== r.index && (n.index = r.index), r.data && r.data.listProps))
                                    for (var i in r.data.listProps) n[i] = r.data.listProps[i];
                                a.push(n)
                        ...
                        update: function(e, t) {
                            if (!(-1 == f._itFl.indexOf(e) || e.upload && e.upload.$ajax)) {
                                ...
                                (e = f._itFl[r]).popup && e.popup.close && e.popup.close(), n.thumbnails && o.html && f.thumbnails.item(e, o.html), f.set("listInput", null)
                            }
                        },
                        find: function(e) {
                            var t = null;
                            return $.each(f._itFl, function(o, r) {
                                if (r.html && r.html.is(e)) return t = r, !1
                            }), t
                        },
                        remove: function(e, t) {
                    ...
                    _assets: {
                        ...
                        secondsToText: function(e, t) {
                            ...
                            var o = Math.floor(e / 3600),
                                r = Math.floor((e - 3600 * o) / 60),
                                n = "";
                            return (o > 0 || !t) && (n += (o < 10 ? "0" : "") + o + (t ? "h " : ":")), (r > 0 || !t) && (n += (r < 10 && !t ? "0" : "") + r + (t ? "m " : ":")), n += ((e = e - 3600 * o - 60 * r) < 10 && !t ? "0" : "") + e + (t ? "s" : "")
                        },
                        ...
                        generateFileName: function(e, t) {
                            ...
                            e = e ? "." + e : "";
                            return (t = t || "") + o.getFullYear() + "-" + r(o.getMonth() + 1) + "-" + r(o.getDate()) + " " + r(o.getHours()) + "-" + r(o.getMinutes()) + "-" + r(o.getSeconds()) + e
                        },
                        arrayBufferToBase64: function(e) {
                            for (var t = "", o = new Uint8Array(e), r = 0; r < o.byteLength; r++) t += String.fromCharCode(o[r]);
                            return window.btoa(t)
                        },
                        dataURItoBlob: function(e, t) {
                            for (var o = atob(e.split(",")[1]), r = e.split(",")[0].split(":")[1].split(";")[0], n = new ArrayBuffer(o.length), i = new Uint8Array(n), a = 0; a < o.length; a++) i[a] = o.charCodeAt(a);
                        ...
                        getExifOrientation: function(e, t) {
                            ...
                            o.onload = function(e) {
                                var o = new DataView(e.target.result),
                                    n = 1;
                                if (65496 == o.getUint16(0, !1))
                                    for (var i = o.byteLength, a = 2; a < i && !(o.getUint16(a + 2, !1) <= 8);) {
                                        var l = o.getUint16(a, !1);
                                        if (a += 2, 65505 == l) {
                                            if (1165519206 != o.getUint32(a += 2, !1)) break;
                                            var s, p = 18761 == o.getUint16(a += 6, !1);
                                            a += o.getUint32(a + 4, p), s = o.getUint16(a, p), a += 2;
                                            for (var d = 0; d < s; d++)
                                                if (274 == o.getUint16(a + 12 * d, p)) {
                                                    n = o.getUint16(a + 12 * d + 8, p), i = 0;
                                                    break
                                                }
                                        } else {
                        ...
                        textToColor: function(e) {
                            ...
                            t = 0;
                            for (var r = "#"; t < 3; r += ("00" + (o >> 2 * t++ & 255).toString(16)).slice(-2));
                            return r
                        },
                        isBrightColor: function(e) {
                            var t, o, r;
                            return ((r = (t = e) && t.constructor == Array && 3 == t.length ? t : (o = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(t)) ? [parseInt(o[1]), parseInt(o[2]), parseInt(o[3])] : (o = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(t)) ? [2.55 * parseFloat(o[1]), 2.55 * parseFloat(o[2]), 2.55 * parseFloat(o[3])] : (o = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(t)) ? [parseInt(o[1], 16), parseInt(o[2], 16), parseInt(o[3], 16)] : (o = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(t)) ? [parseInt(o[1] + o[1], 16), parseInt(o[2] + o[2], 16), parseInt(o[3] + o[3], 16)] : "undefined" != typeof colors ? colors[$.trim(t).toLowerCase()] : null) ? .2126 * r[0] + .7152 * r[1] + .0722 * r[2] : null) > 194
                        }
                    },
            ...
            return n.enableApi && (s.get(0).FileUploader = {
                ...
                add: function(e, t, o) {
                    ...
                    var r;
                    if (e instanceof Blob) r = e;
                    else {
                        var n = /data:[a-z]+\/[a-z]+\;base64\,/.test(e) ? e : "data:" + t + ";base64," + btoa(e);
                        r = f._assets.dataURItoBlob(n, t)
                    }
                    return r._name = o || f._assets.generateFileName(-1 != r.type.indexOf("/") ? r.type.split("/")[1].toString().toLowerCase() : "File "), f.onChange(null, [r]), !0
                },
                append: function(e) {
        ...
        getInstance: function(e) {
            return (e.prop ? e : $(e)).get(0).FileUploader
        }
        ...
        captions: {
            ...
            removeConfirmation: "你確定要刪除此圖片?",
            errors: {
                filesLimit: "Only ${limit} files are allowed to be uploaded.",
                filesType: "Only ${extensions} files are allowed to be uploaded.",
                fileSize: "${name} is too large! Please choose a file up to ${fileMaxSize}MB.",
                filesSizeAll: "Files that you chose are too large! Please upload files up to ${maxSize} MB.",
                fileName: "相同的檔案 ${name} 已被上傳選取",
